# -*- coding: utf-8 -*-
"""Generate the five-language Zap Slots user manual.
...
TITLE = {
    "en": "Zap Slots — User Manual · Farax Creative",
    "ko": "Zap Slots — 사용자 매뉴얼 · Farax Creative",
    "ja": "Zap Slots — ユーザーマニュアル · Farax Creative",
    "pt": "Zap Slots — Manual do Usuário · Farax Creative",
    "es": "Zap Slots — Manual de Usuario · Farax Creative",
}

DESC = {
    "en": "User manual for Zap Slots — a Picture-Viewer-style render history "
          "for Blender. Install, everyday use, screen reference, importing "
          "renders, and what is not in this release.",
    "ko": "Zap Slots 사용자 매뉴얼 — 블렌더용 픽처 뷰어 스타일 렌더 히스토리. "
          "설치, 기본 사용법, 화면 설명, 렌더 불러오기, 이번 버전에서 빠진 것.",
    "ja": "Zap Slots ユーザーマニュアル — Blender 用のピクチャービューア風レンダー"
          "履歴。インストール、基本操作、画面リファレンス、レンダーの読み込み。",
    "pt": "Manual do Zap Slots — um histórico de renders no estilo Picture "
          "Viewer para o Blender. Instalação, uso diário e referência de tela.",
    "es": "Manual de Zap Slots — un historial de renders al estilo Picture "
          "Viewer para Blender. Instalación, uso diario y referencia de pantalla.",
}

BACK = {
    "en": "Back to Zap Slots", "ko": "Zap Slots로 돌아가기",
    "ja": "Zap Slots に戻る", "pt": "Voltar para Zap Slots",
    "es": "Volver a Zap Slots",
}
...
FOOTNOTE = {
    "en": "FARAX CREATIVE &middot; Zap series &middot; Zap Slots",
    "ko": "FARAX CREATIVE &middot; Zap 시리즈 &middot; Zap Slots",
    "ja": "FARAX CREATIVE &middot; Zap シリーズ &middot; Zap Slots",
    "pt": "FARAX CREATIVE &middot; Série Zap &middot; Zap Slots",
    "es": "FARAX CREATIVE &middot; Serie Zap &middot; Zap Slots",
}
...
CONTENT["en"] = """
  ...
  <section>
    ...
    <ol>
      ...
      <li>Render (F12). The <b>Zap Slots Viewer</b> window opens by itself.</li>
  ...
  <section>
    ...
    <ol>
      ...
      <li>Pick <code>zap_slots-2.8.0.zip</code>.</li>
  ...
  <section>
    ...
    drag. Zap Slots refuses to compare two different resolutions rather than
  ...
  <section>
    ...
    <p>Zap Slots lives in its own window, like C4D's Picture Viewer, rather than
  ...
  <section>
    ...
    <p>Press <b>Import</b> and pick a folder to bring in renders Zap Slots did
  ...
  <section>
    ...
    <p>Select a Sequence and open the <b>Info</b> tab. Zap Slots records how
...
Per-frame render time
  ...
  <section>
    ...
    <p>By default the history folder is <code>zap_slots_history</code> next to
    ...
    nothing. Reopen the .blend and Zap Slots rescans the folder and rebuilds the
    list, thumbnails included.</p>
    <p>Zap Slots does not touch your render settings, Blender's own render slots
  ...
  <section style="border-bottom:none">
    ...
    Blender writes no file at all for an interactive F12 still, so Zap Slots has
...
CONTENT["ko"] = """
  ...
  <section>
    ...
    <ol>
      ...
      <li>렌더(F12)하면 <b>Zap Slots Viewer</b> 창이 저절로 열립니다.</li>
  ...
  <section>
    ...
    <ol>
      ...
      <li><code>zap_slots-2.8.0.zip</code>을 선택합니다.</li>
  ...
  <section>
    ...
    Zap Slots는 늘려 맞추지 않고 비교를 거부합니다 — 그렇게 하면 보고 있는 것이
    거짓이 되기 때문입니다.</p>
  </section>
  ...
  <section>
    ...
    <p><b>Import</b>를 누르고 폴더를 고르면 Zap Slots가 만들지 않은 렌더도
...
Per-frame render time
  ...
  <section>
    <h2>저장 위치와 지속성</h2>
    <p>기본값은 .blend 옆의 <code>zap_slots_history</code> 폴더입니다(저장 안 된
  ...
  <section style="border-bottom:none">
    ...
    아예 쓰지 않기 때문에 Zap Slots가 렌더 결과에서 직접 만들어야 하는데, 그
...
CONTENT["ja"] = """
  ...
  <section>
    ...
    <ol>
      ...
      <li>レンダー（F12）すると <b>Zap Slots Viewer</b> ウィンドウが自動で開きます。</li>
  ...
  <section>
    ...
    <ol>
      ...
      <li><code>zap_slots-2.8.0.zip</code> を選択します。</li>
  ...
  <section>
    ...
    Zap Slots は引き伸ばして合わせず比較を拒否します — それでは見ているものが
    偽りになるからです。</p>
  </section>
  ...
  <section>
    ...
    <p><b>Import</b> を押してフォルダを選ぶと、Zap Slots が作ったものでない
...
Per-frame render time
  ...
  <section>
    <h2>保存先と永続性</h2>
    <p>既定では .blend の隣の <code>zap_slots_history</code> フォルダです
  ...
  <section style="border-bottom:none">
    ...
    静止画に対してファイルを一切書き出さないため、Zap Slots が Render Result
...
CONTENT["pt"] = """
  <h1>Zap Slots — Manual do Usuário</h1>
  ...
  <section>
    ...
    <ol>
      ...
      <li>Renderize (F12). A janela <b>Zap Slots Viewer</b> abre sozinha.</li>
  ...
  <section>
    ...
    <ol>
      ...
      <li>Escolha <code>zap_slots-2.8.0.zip</code>.</li>
  ...
  <section>
    ...
    uma linha que você arrasta. O Zap Slots se recusa a comparar resoluções
  ...
  <section>
    ...
    <p>O Zap Slots vive em sua própria janela, como o Picture Viewer do C4D, em
  ...
  <section>
    ...
    <p>Selecione uma Sequence e abra a aba <b>Info</b>. O Zap Slots registra
...
Per-frame render time
  ...
  <section>
    ...
    <p>Por padrão a pasta do histórico é <code>zap_slots_history</code> ao lado
    ...
    nada. Reabra o .blend e o Zap Slots revarre a pasta e reconstrói a lista,
    miniaturas incluídas.</p>
    <p>O Zap Slots não mexe nas suas configurações de render, nos render slots
  ...
  <section style="border-bottom:none">
    ...
    interativo, então o Zap Slots precisa produzir um a partir do Render Result,
...
CONTENT["es"] = """
  <h1>Zap Slots — Manual de Usuario</h1>
  ...
  <section>
    ...
    <ol>
      ...
      <li>Renderiza (F12). La ventana <b>Zap Slots Viewer</b> se abre sola.</li>
  ...
  <section>
    ...
    <ol>
      ...
      <li>Elige <code>zap_slots-2.8.0.zip</code>.</li>
  ...
  <section>
    ...
    puedes arrastrar. Zap Slots se niega a comparar resoluciones distintas en
  ...
  <section>
    ...
    <p>Zap Slots vive en su propia ventana, como el Picture Viewer de C4D, en
  ...
  <section>
    ...
    <p>Pulsa <b>Import</b> y elige una carpeta para traer renders que Zap Slots
  ...
  <section>
    ...
    <p>Selecciona una Sequence y abre la pestaña <b>Info</b>. Zap Slots registra
...
Per-frame render time
  ...
  <section>
    ...
    <p>Por defecto la carpeta del historial es <code>zap_slots_history</code>
    ...
    nada. Reabre el .blend y Zap Slots vuelve a escanear la carpeta y reconstruye
    la lista, miniaturas incluidas.</p>
    <p>Zap Slots no toca tus ajustes de render, los render slots propios de
  ...
  <section style="border-bottom:none">
    ...
    interactivo, así que Zap Slots tiene que producir uno a partir del Render
...
def build():
    ...
    # Zap Slots has no such list, so drop that script but keep the language
    ...
    for suffix, code, _label in LANGS:
        out_name = "zap-slots.html" if not suffix else "zap-slots.%s.html" % suffix
        h = head
        ...
        h = h.replace("#zap-doctor", "#zap-slots")
        h = h.replace("Back to Zap Doctor", BACK[code])
        h = h.replace("ZAP SERIES / USER MANUAL", KICKER[code])
        # language switcher: point at zap-slots files and mark the current one
        h = h.replace("zap-doctor.html", "zap-slots.html")
        for s2, c2, _l2 in LANGS:
            if s2:
                h = h.replace("zap-doctor.%s.html" % s2, "zap-slots.%s.html" % s2)
